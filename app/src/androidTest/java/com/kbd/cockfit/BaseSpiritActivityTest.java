...
public class BaseSpiritActivityTest {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void baseSpiritActivityTest() {
        ...
        ViewInteraction materialButton2 = onView(
                allOf(withId(R.id.commonsense_basespirit_button), withText("기주"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction overflowMenuButton = onView(
                allOf(withContentDescription("More options"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.basespirit_materialToolbar),
                                        2),
                                0),
                        isDisplayed()));
